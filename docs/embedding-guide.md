...
All examples assume a host Pict application that extends `pict-application`. If you are starting from scratch, see [pict-application](https://fable-retold.github.io/pict-application/) first.
